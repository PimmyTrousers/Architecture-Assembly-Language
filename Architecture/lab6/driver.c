...
void collection_fun(Collection evens, Collection odds, Collection all) {//collection all = 0x0
  ...
  print_collection_array(snapshot, odds->size);// odds->size is 1??
